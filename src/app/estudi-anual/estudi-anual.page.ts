...
export class EstudiAnualPage implements OnInit {
  ...
  goToNotasDesertores() {
    ...
    pentahoContainer.innerHTML = `
      <iframe src="http://localhost:8080/pentaho/content/saiku-ui/index.html?biplugin5=true&dimension_prefetch=false#query/open/%3Ahome%3Aconsultas%3Apromedio-ponderado.saiku" style="width:100%; height:1100px; border:none;"></iframe>
    `;
  }

  generatePDF() {
    const iframeSrc = 'http://localhost:8080/pentaho/content/saiku-ui/index.html?biplugin5=true&dimension_prefetch=false#query/open/%3Ahome%3Aconsultas%3Apromedio-ponderado.saiku';
